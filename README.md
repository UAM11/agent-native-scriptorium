...
- [DeepSeek LLM Paper Reading Note](learning/deepseek-llm-v1-paper-reading.md): a section-by-section reading note that follows the original `DeepSeek LLM` paper structure and embeds key figure/table reading cards
- [DeepSeekMoE Paper Reading Note](learning/deepseek-moe-paper-reading.md): a paper-reading note focused on how DeepSeek redesigns MoE around finer-grained experts, shared experts, and stronger expert specialization
- [DeepSeek-V2 Paper Reading Note](learning/deepseek-v2-paper-reading.md): a paper-reading note focused on how `DeepSeekMoE + MLA` become a strong, economical, long-context model with practical training and inference gains
- [DeepSeek V1-V4 Research Route](learning/deepseek-v1-to-v4-research-route.md): a study note that turns the `DeepSeek LLM / V1 -> V4` story into four parallel lines: pretraining, architecture, post-training, and systems engineering
