...
- [DeepSeek Stage 2 Paper Reading Note](learning/deepseek-moe-and-v2-paper-reading.md): a guided reading note for the second DeepSeek phase that reads `DeepSeekMoE` and `DeepSeek-V2` together as one “economical scaling” stage
