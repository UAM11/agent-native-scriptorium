...
- [DeepSeekMoE 论文阅读笔记](learning/deepseek-moe-paper-reading.md)：第二阶段里偏架构发明的一篇，重点看 `DeepSeekMoE` 怎样通过 finer-grained experts 与 shared experts 提高 expert specialization
- [DeepSeek-V2 论文阅读笔记](learning/deepseek-v2-paper-reading.md)：第二阶段里偏系统整合的一篇，重点看 `DeepSeekMoE + MLA` 如何真正落成一代经济、强大、可部署的模型
