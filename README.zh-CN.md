...
- [DeepSeek 第二阶段论文阅读笔记：DeepSeekMoE 与 DeepSeek-V2](learning/deepseek-moe-and-v2-paper-reading.md)：把 `DeepSeekMoE` 与 `DeepSeek-V2` 放进同一阶段阅读，集中理解 DeepSeek 如何把“继续做大模型”变成一件更经济的事
